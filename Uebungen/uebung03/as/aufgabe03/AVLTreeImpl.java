...
class AVLTreeImpl<K extends Comparable<? super K>, V> extends
  ...
  public V put(K key, V value) {
    // TODO Implement here...testen ob es schon ein Eintrag gibt
    Entry<K, V> entry=find(key);
    if(entry!= null){
      return entry.setValue(value);
    }else{
      super.insert(key, value);
      //nach Aufruf -> neuer Knoten, null zurückgeben weil neuer Wert hinzugefügt wurde
  ...
  protected Node insert(Node node, Entry<K, V> entry) {
    // TODO Implement here..., neu noch Parent Verbindung setzten (Man in de Middle)
